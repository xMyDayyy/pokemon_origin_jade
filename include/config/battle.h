...
#define B_SPLIT_EXP                 GEN_5 // Origin Jade: Erfahrung wird wieder unter den Teilnehmern
                                          // geteilt. Mit GEN_LATEST bekam jedes teilnehmende Pokemon die
                                          // volle Erfahrung, was den Kanto-Levelkorridor gesprengt hat.
